        ...
        <div class="row flex-column flex-sm-row wrapper min-vh-100">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($Result)){ ?>
                                        <tr>
                                            ...
                                            <td><button type="submit"><a href="roomm.php?edit=<?php echo $row['id']; ?>" style="color:#000; text-decoration:none;">Edit</a></button></td>
                                            <td><input type="button" onclick="deleteme(<?php echo $row['id']; ?>)" name="Delete" value="Delete"></td>
                                        </tr>
                                        <script language="javascript">
                                            function deleteme(delid){
                                                if (confirm("Are you sure you want to delete this record?")) {
                                                    window.location.href='Room.php?delete=' +delid+'';
                                                    return true;
                                                }
                                            }
                                        </script>
            ...
            <div class="input-group">
                ...
                <div style="color:red;"><?php
                        ...
                        <?php }?></div>
                <input placeholder="Capacity" maxlength="1" type="number" name="capacity" onkeyup="val(this)" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(10, this.maxLength);" value="<?php echo $capacity;?>" required="required">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <?php if ($edit_state == true): ?>
                    <button type="submit" name="update" class="btn">UPDATE</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" class="btn"><a href="roomm.php" style="color:#fff;">BACK</a></button>
                <?php else: ?>
