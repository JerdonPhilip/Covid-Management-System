        ...
        <div class="row flex-column flex-sm-row wrapper min-vh-100">
            ...
            <div class="input-group">
                ...
                <div style="color:red;"><?php
                        ...
                        <?php }?></div>
                <input placeholder="Capacity" type="text" name="capacity" onkeyup="val(this)" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" value="<?php echo $capacity;?>" required="required">
                &nbsp;&nbsp;&nbsp;&nbsp;
