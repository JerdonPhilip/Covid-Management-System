        ...
        <div class="row flex-column flex-sm-row wrapper min-vh-100">
            ...
            <div class="col colll">
                <div class="row roww">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)): ?>
                                        <tr>
                                            ...
                                            <td><button type="button"><a href="brgy.php?edit=<?php echo $row['id']; ?>" style="color:#000; text-decoration:none;">Edit</a></button></td>
                                            <td><input type="button" onclick="deleteme(<?php echo $row['id']; ?>)" name="Delete" value="Delete"></td>
                                        </tr>
                                        <script language="javascript">
                                            function deleteme(delid){
                                                if (confirm("Are you sure you want to delete this record?")) {
                                                    window.location.href='brgy.php?delete=' +delid+'';
                                                    return true;
                                                }
                                            }
                                        </script>
                    ...
                    <div class="col fillupform">
                        <form action="brgy.php" method="post">
            ...
            <div class="input-group">
                <?php if ($edit_state == true): ?>
                    ...
                    <button type="button" class="btn"><a href="brgy.php" style="color:#fff;">BACK</a></button>
                <?php else: ?>
