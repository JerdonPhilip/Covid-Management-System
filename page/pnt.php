...
<body>
    <div class="container-fluid">
        <div class="row flex-column flex-sm-row wrapper min-vh-100">
                                   ...
                                   <?php 
                                    while ($row = mysqli_fetch_array($results)) : ?>
                                        <tr>
                                            ...
                                            <td><button type="button" class="edt"><a href="pnt.php?edit=<?php echo $row['id']; ?>" style="color:#000; text-decoration:none;">Edit</a></button></td>
            ...
            <tr class="input-group">
                <td><div id="edad"></div><input type="text" name="age" placeholder="Age" id="age" onkeyup="num(this)" style="width: 300px" value="<?php echo $age; ?>" required>
                </td>
