                        ...
                        <div class="table-responsive table table-hover table-bordered results" id="tabmin">
                            <table class="table table-hover table-bordered sticky" id="myTable">
                                ...
                                <thead class="bill-header cs">
                                    <tr>
                                    <th class="col coll">First Name</th>
                                    <th class="col coll">Last Name</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)): ?>
                                        <tr>
                                            <td class="col"><?php echo strtoupper($row['firstname']); ?></td>
                                            <td class="col"><?php echo strtoupper($row['lastname']); ?></td>
